...
class TestSampleBotAi(unittest.TestCase):
    def test_should_avoid_obstacles(self):
        ...
        self.assertEqual(SampleBotAi().make_move(1, game_state).step1, LEFT)
    ...
    def test_should_collect_nearest_treasure(self):
        ...
        game_state = game_state_factory.create_from_game_plan_lines(game_plan)
        self.assertEqual(SampleBotAi().make_move(1, game_state).step1, DOWN)
    ...
    def test_should_collect_treasure_with_double_move(self):
        ...
        game_state = game_state_factory.create_from_game_plan_lines(game_plan)
        self.assertEqual(SampleBotAi().make_move(1, game_state), Move(RIGHT, RIGHT))
